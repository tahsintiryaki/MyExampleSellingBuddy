...
namespace EventBus.AzureServiceBus
{
    public class EventBusServiceBus : BaseEventBus
    {
        ...
        private ISubscriptionClient CreateSubscriptionClientIfNotExists(string eventName)
        {
            ...
            var exists = managementClient.SubscriptionExistsAsync(EventBusConfig.EventBusConnectionString, GetSubName(eventName)).GetAwaiter().GetResult();
            if (!exists)
            {
        ...
        private void RemoveDefaultRule(SubscriptionClient subscriptionClient)
        {
            ...
            catch (MessagingEntityNotFoundException)
            {
                ...
                logger.LogWarning("The messaging entity {DefaultRuleName} Cound not be found.", RuleDescription.DefaultRuleName);
            }
        }
        ...
        private void CreateRuleIfNotExists(string eventName, ISubscriptionClient subscriptionClient)
        {
            ...
            try
            {
                //rulename ve evenName aynı olacak!
