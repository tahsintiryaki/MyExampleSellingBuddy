...
namespace OrderService.Application.DomainEventHandlers
{
    ...
    {
        //domain event handler Event bus'tan bağımsız. Order start edildiğinde sadece Order domaini içerisinde bir şeyler yapılmak istenildiğinde kullanılıyor. Aynı domain içerisinde katmanların birbiri ile harberleşmesi için kullanılır.
